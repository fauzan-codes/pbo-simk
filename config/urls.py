...
urlpatterns = [
    ...
    path('farmasi/stok-obat/<int:id>/tambah/', farmasi_views.stok_obat_tambah, name='stok_obat_tambah'),
    path('farmasi/stok-obat/<int:id>/kurangi/', farmasi_views.stok_obat_kurangi, name='stok_obat_kurangi'),
